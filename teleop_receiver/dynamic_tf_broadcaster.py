...
def compute_distance_from_odom(wheel_front_left, wheel_front_right, wheel_back_left, wheel_back_right):
    x = 2 * np.pi / 1440 * (wheel_front_left + wheel_front_right + wheel_back_left + wheel_back_right) * 0.04 / 4
    y = 2 * np.pi / 1440 * (-wheel_front_left + wheel_front_right + wheel_back_left - wheel_back_right) * 0.04 / 4
    omega = 2 * np.pi / 1440 * (-wheel_front_left + wheel_front_right - wheel_back_left + wheel_back_right) * 0.04 / 4
    return x, y, omega
