...
def compute_distance_from_odom(wheel_front_left, wheel_front_right, wheel_back_left, wheel_back_right):
    x = (((wheel_front_left + wheel_front_right + wheel_back_left + wheel_back_right) / 4) / 1440) * (2 * np.pi *0.04)
    y = (((-wheel_front_left + wheel_front_right + wheel_back_left - wheel_back_right) / 4)/1440) * (2 * np.pi * 0.04)
    omega = (((-wheel_front_left + wheel_front_right - wheel_back_left + wheel_back_right) /4) / 1440) * (2 * np.pi *0.04)
    return x, y, omega
